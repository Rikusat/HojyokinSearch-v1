...
info_to_ask = f"{selected_地域} の補助金リストの中で、{', '.join(selected_options)} に交付している補助金を可能な限り多く教えてください"
    ...
    if df_search.empty:
       ...
       # Use OpenAI API
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "全て日本語で返答してください.質問に対して可能な限り多くデータを参照し、箇条書きで書き出してください"},
